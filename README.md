Report how much money the user spends and makes in each of the months for which we have data. (Assumption is that it is for that User and there might be gap months or no data at all.)
